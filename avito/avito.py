...
def prep_train():
    ...
    pairs = pd.read_csv("~/Documents/kaggle/avito/input/ItemPairs_train.csv", dtype=types1)
    # Add 'id' column for easy merge
    print("Load ItemInfo_train.csv")
    items = pd.read_csv("~/Documents/kaggle/avito/input/ItemInfo_train.csv", dtype=types2)
    items.fillna(-1, inplace=True)
    location = pd.read_csv("~/Documents/kaggle/avito/input/Location.csv")
    category = pd.read_csv("~/Documents/kaggle/avito/input/Category.csv")
...
def prep_test():
    ...
    pairs = pd.read_csv("~/Documents/kaggle/avito/input/ItemPairs_test.csv", dtype=types1)
    print("Load ItemInfo_testcsv")
    items = pd.read_csv("~/Documents/kaggle/avito/input/ItemInfo_test.csv", dtype=types2)
    items.fillna(-1, inplace=True)
    location = pd.read_csv("~/Documents/kaggle/avito/input/Location.csv")
    category = pd.read_csv("~/Documents/kaggle/avito/input/Category.csv")
